  ...
  return (
    <div className="interpretation">
      ...
      <p className="attribution">
        {showWilhelm
          ? 'Judgement and Image are shortened Wilhelm/Baynes. Line texts are the full Wilhelm/Baynes translation per line. Hexagram follows classical three-coin scoring so results match standard charts.'
